import { i as e, o as t, r as n } from "./client-C2Div8lN.js";
import {
  _ as r,
  a as i,
  c as a,
...
var y = class extends v {
    ...
    (r && C(this.#t, n, this.options, t) && this.#h(),
      ...
      r &&
        (this.#t !== n ||
          ...
          s(this.options.staleTime, this.#t) !== s(t.staleTime, this.#t)) &&
        this.#g());
    let i = this.#_();
    r &&
      (this.#t !== n ||
  ...
  getOptimisticResult(e) {
    ...
    return (T(this, n) && ((this.#r = n), (this.#a = this.options), (this.#i = this.#t.state)), n);
  }
  getCurrentResult() {
    return this.#r;
  }
  ...
  #g() {
    ...
    if (p.isServer() || this.#r.isStale || !a(e)) return;
  ...
  #v(e) {
    (this.#x(),
      (this.#p = e),
      !(p.isServer() || o(this.options.enabled, this.#t) === !1 || !a(this.#p) || this.#p === 0) &&
        (this.#f = c.setInterval(() => {
          (this.options.refetchIntervalInBackground || r.isFocused()) && this.#h();
        }, this.#p)));
  }
  #y() {
  ...
  #b() {
    this.#d !== void 0 && (c.clearTimeout(this.#d), (this.#d = void 0));
  }
  #x() {
    this.#f !== void 0 && (c.clearInterval(this.#f), (this.#f = void 0));
  }
  createResult(e, t) {
    let n = this.#t,
      r = this.options,
    ...
    let { error: m, errorUpdatedAt: g, status: v } = d;
    p = d.data;
    let y = !1;
    if (t.placeholderData !== void 0 && p === void 0 && v === `pending`) {
      let e;
      (a?.isPlaceholderData && t.placeholderData === c?.placeholderData
        ...
        : (e =
            typeof t.placeholderData == `function`
              ...
              : t.placeholderData),
        e !== void 0 && ((v = `success`), (p = _(a?.data, e, t)), (f = !0)));
    }
    if (t.select && p !== void 0 && !y)
      if (a && p === s?.data && t.select === this.#c) p = this.#l;
      else
        try {
          ((this.#c = t.select),
            (p = t.select(p)),
    ...
    this.#s && ((m = this.#s), (p = this.#l), (g = Date.now()), (v = `error`));
    ...
    if (this.options.experimental_prefetchInRender) {
      let t = O.data !== void 0,
        ...
        o = () => {
          let e = (this.#o = O.promise = i());
          a(e);
        },
        s = this.#o;
      switch (s.status) {
        case `pending`:
          e.queryHash === n.queryHash && a(s);
          break;
        case `fulfilled`:
          (r || O.data !== s.value) && o();
          break;
        case `rejected`:
          (!r || O.error !== s.reason) && o();
          break;
      }
    }
    return O;
...
function b(e, t) {
  return (
    o(t.enabled, e) !== !1 &&
    e.state.data === void 0 &&
    !(e.state.status === `error` && o(t.retryOnMount, e) === !1)
  );
}
function x(e, t) {
...
function S(e, t, n) {
  if (o(t.enabled, e) !== !1 && s(t.staleTime, e) !== `static`) {
...
function C(e, t, n, r) {
  return (
    (e !== t || o(r.enabled, e) === !1) && (!n.suspense || e.state.status !== `error`) && w(e, n)
  );
}
function w(e, t) {
  return o(t.enabled, e) !== !1 && e.isStaleByTime(s(t.staleTime, e));
}
function T(e, t) {
...
var A = E.createContext(k()),
  ...
  M = (e, t, n) => {
    let r =
      n?.state.error && typeof e.throwOnError == `function`
        ? f(e.throwOnError, [n.state.error, n])
        : e.throwOnError;
  ...
  P = ({ result: e, errorResetBoundary: t, throwOnError: n, query: r, suspense: i }) =>
    e.isError &&
    !t.isReset() &&
    !e.isFetching &&
    r &&
    ((i && e.data === void 0) || f(n, [e.error, r])),
  F = (e) => {
    if (e.suspense) {
      let t = 1e3,
...
function z(e, t, n) {
  ...
  let s = a.getQueryCache().get(o.queryHash),
    c = e.subscribed !== !1;
  ((o._optimisticResults = r ? `isRestoring` : c ? `optimistic` : void 0), F(o), M(o, i, s), N(i));
  ...
  if (
    (E.useSyncExternalStore(
      E.useCallback(
        (e) => {
          let t = h ? f.subscribe(u.batchCalls(e)) : d;
  ...
  return (
    ...
    o.experimental_prefetchInRender &&
      !p.isServer() &&
      I(m, r) &&
      (l ? R(o, f, i) : s?.promise)?.catch(d).finally(() => {
        f.updateResult();
      }),
