import { i as e, o as t } from "./client-C2Div8lN.js";
import { i as n, l as r, m as i, n as a, p as o, s, t as c, v as l } from "./index-D35RyiWQ.js";
var u = class extends l {
    ...
    setOptions(e) {
      ...
      ((this.options = this.#e.defaultMutationOptions(e)),
        ...
        s(t.mutationKey) !== s(this.options.mutationKey)
          ? this.reset()
...
function f(e, t) {
  let a = c(t),
    [o] = d.useState(() => new u(a, e));
  d.useEffect(() => {
    o.setOptions(e);
  }, [o, e]);
  let s = d.useSyncExternalStore(
      d.useCallback((e) => o.subscribe(n.batchCalls(e)), [o]),
      () => o.getCurrentResult(),
      () => o.getCurrentResult(),
    ),
    l = d.useCallback(
      (e, t) => {
        o.mutate(e, t).catch(r);
      },
      [o],
    );
  if (s.error && i(o.options.throwOnError, [s.error])) throw s.error;
